                ...
                with open(collection_file_path, mode='r', encoding='utf-8') as file:
                    ...
                    for row in reader:
                        if row["Document ID"].strip() == upload_id:
                            return row["Document Name"].strip()  # Retourne le nom du fichier PDF
            except Exception as e:
                print(f"Erreur de lecture du fichier {collection_file_path}: {e}")
    return None  # Si le nom du fichier n'est pas trouvé
...
def afficher_details(questions_data):
    ...
    for question_data in questions_data:
        ...
        print(f"- Nom du fichier PDF : {question_data['pdf_name']}")
        print("-" * 50 + "\n")
    print("\n--- Fin de l'affichage ---\n")
...
def main():
    ...
    for question_file_path, question_text in questions:
        ...
        question_data = {
            ...
            'pdf_name': None  # Nom du fichier PDF
        }
        ...
        if documents_id:
            ...
            if full_answer:
                ...
                # Recherche du nom du fichier PDF
    ...
    # Affichage des détails des questions traitées
